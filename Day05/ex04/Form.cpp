...
Form::Form() :
_name("Laisser-passer A38"), _gradeToSign(1), _gradeToExecute(1), _isSigned(false), _isExecuted(false) { }

Form::Form(std::string name, int toSign, int toExecute) : 
_name(name), _gradeToSign(toSign), _gradeToExecute(toExecute), _isSigned(false), _isExecuted(false)
{
...
Form &				Form::operator=(Form const &rhs)
{
	...
	this->_isExecuted = rhs._isExecuted;
...
void				Form::setExecuted(bool executedToSet)
{
	this->_isExecuted = executedToSet;
}
