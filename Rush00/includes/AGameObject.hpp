...
protected:
	...
	int				_scrollDelay;			// The speed at which the game object scrolls in the screen
...
public:
	...
	virtual void	move(Context *context, int x, int y) = 0;			// Allows the object to implement its own moveset and detect collisions

	Coordinates		getCoordinates() const;						// Allows to get the X and Y coordinates of the object
	int 			getScrollDelay() const;						// Allows to get the scroll speed of the object
